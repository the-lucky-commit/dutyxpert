  ...
  return (
    <article className="bg-white text-slate-700 py-20 md:py-28">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <p className="mt-3 leading-7">ท่านสามารถขอเข้าถึง แก้ไข ลบ จำกัดหรือคัดค้านการใช้ข้อมูล รวมถึงถอนความยินยอมในกรณีที่เราอาศัยความยินยอมเป็นฐาน โดยติดต่อที่ info@dutyxpert.com หรือ 086-368-2323</p>
